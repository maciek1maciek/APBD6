    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "test@test.com", "Jan", "Kowalski" },
                    { 2, "test@test2.com", "Mirek", "Kowalski" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1990, 10, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Jan", "Kowalski" },
                    { 2, new DateTime(1990, 10, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Mirek", "Kowalski" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1999, 2, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2002, 2, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1 },
                    { 2, new DateTime(1999, 3, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2010, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 2 }
                });
